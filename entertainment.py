...
#Assign movie titles with poster image and trailer. 
#Create instance of Movie class for each title.
the_other_guys = media.Movie(
	"The Other Guys",
	"http://img.moviepostershop.com/the-other-guys-movie-poster-2010-1020545762.jpg",
	"https://www.youtube.com/watch?v=D6WOoUG1eNo")

star_wars_ep3 = media.Movie(
	"Star Wars Episode 3",
...
american_psycho = media.Movie(
	"American Psycho",
	"http://t1.gstatic.com/images?q=tbn:ANd9GcR42NIX4d1J7ehsoZ9jAQoI04YS9Cz0cohVJvKkKLo7PVz7jj1B",
...
#Create list of movies that will be opened and displayed by fresh tomatoes.
movies = [
	the_other_guys, star_wars_ep3, step_brothers,
	american_psycho, office_space, die_hard] 

#Open movies with function called from fresh tomatoes.
